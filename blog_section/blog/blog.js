...
const blogPosts = [
  {
    ...
    excerpt: "Learn what AQI means, how it's calculated, and why it matters for your daily health decisions.",
    category: "air-quality",
    author: "Dr. Sarah Chen",
    date: "2024-01-15",
    readTime: "5 min read",
    image: "https://environmental-initiative.org/wp-content/uploads/2022/05/WordPress_AQI_202222-1110x740.webp",
    content: `
  ...
  },
  {
    ...
    excerpt: "Discover nature's air purifiers and learn how these plants can improve your home's air quality.",
  ...
  },
  {
    ...
    excerpt: "Exploring the complex relationship between global warming and air pollution patterns.",
    category: "climate-change",
    author: "Prof. James Wilson",
    date: "2024-01-10",
    readTime: "7 min read",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiXSsm6Gstx9xUXRmdOpzHSwoqMovl5-QI3Q&s",
    content: `
  ...
  },
  {
    ...
    excerpt: "Review of the latest smart air purification technologies and their effectiveness.",
    category: "technology",
    author: "Alex Kim",
    date: "2024-01-08",
    readTime: "6 min read",
    image: "https://acko-cms.ackoassets.com/Xiaomi_Smart_Purifier_4_1_2497047a1e.jpg",
    content: `
  ...
  },
  {
    ...
    excerpt: "Examining the long-term health impacts of poor air quality on communities worldwide.",
    category: "health",
    author: "Dr. Emily Park",
    date: "2024-01-05",
    readTime: "8 min read",
    image: "https://www.shutterstock.com/image-vector/bridging-health-divide-start-new-600nw-2328285273.jpg",
    content: `
  ...
  },
  {
    ...
    excerpt: "Practical tips for eco-friendly transportation choices that improve air quality.",
    category: "green-living",
    author: "Michael Green",
    date: "2024-01-03",
    readTime: "5 min read",
    image: "https://upload.wikimedia.org/wikipedia/commons/8/85/Clean_mobility_instead_of_dirty_traffic.jpg",
    content: `
    ...
    `,
    tags: ["Transportation", "Sustainability", "Carbon Footprint", "Green Living"]
  }
];
...
function loadPosts() {
  ...
  const endIndex = Math.min(currentLoadIndex + postsPerLoad, filteredPosts.length);
...
function setupPostActionsDropdown() {
  ...
  document.getElementById('edit-post-btn').addEventListener('click', openEditPostSelection);
  document.getElementById('delete-post-btn').addEventListener('click', openDeletePostSelection);
}
...
function openEditPostSelection() {
  ...
  const userPosts = blogPosts.filter(post => post.author === 'Current User' || post.id > 6); // Posts created by user
  ...
  const modalHTML = `
    <div class="post-selection-modal" id="post-selection-modal">
      <div class="modal-content">
        ...
        <div class="post-list">
          ${posts.map(post => `
            <div class="post-selection-item" onclick="handlePostAction('${action}', ${post.id})">
              <div class="post-item-info">
                <h4>${post.title}</h4>
                <p>Category: ${getCategoryName(post.category)} | Date: ${formatDate(post.date)}</p>
              </div>
...
function openEditPostModal(post) {
  ...
  document.getElementById('edit-post-content').value = post.content.replace(/<p>/g, '').replace(/<\/p>/g, '\n\n').trim();
...
function handleEditPost(form) {
  ...
  if (postIndex !== -1) {
    ...
    blogPosts[postIndex] = {
      ...
      image: formData.get('image') || 'https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=400&h=200&fit=crop',
